  ...
  return (
    <div>
      ...
      <div className="flex justify-center">
        <div className="mt-10 ml-4 flex flex-col gap-y-8 w-3/4">
              ...
              <div>
                ...
                >
                  ...
                  {customerNames.map((name) => (
                    <option value={name.CustomerName}>
                      {name.CustomerName}
                    </option>
                  ))}
                </select>
          ...
          <div className=" border shadow shadow-cyan-200 p-3 rounded-xl w-fit">
            ...
            <button
              onClick={AddItems}
              className="bg-green-700 text-white text-sm h-9 w-full mr-2 mt-4 rounded-md hover:bg-green-800"
            >
              Add Items
            </button>
          </div>
          ...
          <div className="flex justify-between ">
           <div>
              ...
              <input
                type="date"
                className="border pl-1 rounded py-1 w-80"
            ...
            <div>
              Payment Terms:- <span className="mr-1"></span>
              <input
                type="text"
                className="border pl-1 rounded w-80 py-1"
          ...
          <div className="flex justify-between bg-gray-100 px-4 py-3 rounded-lg">
            <div className="flex gap-2 ml-8">
              <div className="font-semibold">Order Value before GST:-</div>
              <div className="w-20">
                <input
                  type="number"
                  disabled
            ...
            <div className="flex gap-2">
              <div className="font-semibold">Order Value after GST:- </div>
              <div className="w-20">
                <input
                  type="number"
                  disabled
